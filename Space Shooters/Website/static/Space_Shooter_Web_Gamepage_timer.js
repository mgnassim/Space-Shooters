...
function updatetimer() {
    ...
    if (seconden<=0){window.open("http://localhost:63342/Space%20Shooters/Website/templates/Space_Shooter_Web_NL_Scoreboard.html?_ijt=b8fr063qpcq50ub1rpg7vkhlo2","_self")
